...
gpkgPATH = folder + "/natural_earth_vector.gpkg/packages/miniGPKG.gpkg"

data = r"C:\Users\miria\OneDrive - Scientific Network South Tyrol\Semester 2\Advanced Geomatics\Miriam_Faerber\data"

covidPATH = data + "/dpc-covid19-ita-regioni.csv"

# output folder
outputFolder = r"C:\Users\miria\OneDrive - Scientific Network South Tyrol\Semester 2\Advanced Geomatics\Miriam_Faerber\Covid exercise\output_folder"
